...
import com.employee.performance.repository.DepartmentRepository;
...
// 类注释：这是 DepartmentService 模块的业务服务类，用于承载核心业务逻辑并协调数据读写。
...
public class DepartmentService {
    ...
    public Department updateDepartment(Long id, Department department) {
        ...
        if (existing != null) {
            ...
            // 行注释：给实体对象字段赋值，用于新增或更新业务数据。
            existing.setLevel(department.getLevel());
            // 行注释：给实体对象字段赋值，用于新增或更新业务数据。
            existing.setFunctionDesc(department.getFunctionDesc());
            // 行注释：给实体对象字段赋值，用于新增或更新业务数据。
