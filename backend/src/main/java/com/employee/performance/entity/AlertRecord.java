...
// 类注释：这是 AlertRecord 模块的实体类，用于映射数据库表结构并承载业务数据字段。
...
public class AlertRecord {
     ...
     * 预警主键（数据库自增）。
     *
     * <p>@GeneratedValue(strategy = IDENTITY) 对应 MySQL 的 AUTO_INCREMENT。</p>
     */
    // 行注释：声明该字段是数据库表主键。
    @Id
    ...
    /**
     * 触发预警的业务对象类型（task/goal/evaluation 等）。
     */
    // 行注释：配置字段与数据库列之间的映射关系。
