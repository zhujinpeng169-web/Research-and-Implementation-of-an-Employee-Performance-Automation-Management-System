...
// 类注释：这是 Evaluation 模块的实体类，用于映射数据库表结构并承载业务数据字段。
...
public class Evaluation {
    ...
    /**
     * 评估状态，例如：pending / in_progress / completed。
     */
    // 行注释：声明成员变量，用于保存依赖对象或实体字段数据。
